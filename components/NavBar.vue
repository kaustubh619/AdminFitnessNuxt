  ...
  <div>
    ...
    >
      ...
      <div class="navbar__parent">
        <nuxt-link to="/dashboard/users/admin">
      ...
      <p>Products</p>
      <div class="navbar__parent">
        <nuxt-link to="/dashboard/products/product_category">
          <i data-feather="menu"></i>
          <span>Category</span>
        </nuxt-link>
      </div>
      <div class="navbar__parent">
        <nuxt-link to="/dashboard/products/sub-category">
          <i data-feather="filter"></i>
          <span>Sub Category</span>
        </nuxt-link>
      </div>
      <div class="navbar__parent">
        <nuxt-link to="/dashboard/products/brands">
          <i data-feather="tag"></i>
          <span>Brands</span>
        </nuxt-link>
      </div>
      <div class="navbar__parent">
        <nuxt-link to="/dashboard/products/product_list">
